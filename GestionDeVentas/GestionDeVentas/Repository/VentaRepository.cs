...
namespace GestionDeVentas.Repository
{
    public class VentaRepository
    {
        ...
        public void RegistrarVenta(Venta venta)
        {
            ...
            try
            {
                using (SqlCommand cmd = new SqlCommand("INSERT INTO Venta(Comentarios, IdUsuario) VALUES(@comentarios, @idUsuario); SELECT @@Identity", conexion))
                {
                    ...
                    if (venta.ProductosVendidos != null && venta.ProductosVendidos > 0)
                    {
        ...
        {
            Producto? producto = ProductoRepository.obtenerProductoSimplificadoPorId(productoVendido.IdProducto, conexion);
            if (producto != null)
            {
